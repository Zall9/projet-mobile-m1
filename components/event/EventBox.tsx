import {ArrowDownIcon, ArrowLeftIcon, ArrowRightIcon, ArrowUpIcon,} from "@chakra-ui/icons";
...
function handler(event: IEvent, setEvent: Dispatch<SetStateAction<IEvent>>, output: IOutput, setGoMinigame: Dispatch<SetStateAction<IOutput>>): void {
...
export default function EventBox(this: any, props: {
    event: IEvent;
    ...
    useEffect(() => {
        let minigame = goWithOutput.whichMinigame ? MinigameController.getById(goWithOutput.whichMinigame) : MinigameController.pickRandomMinigame();
        const data = {minigame, nextEvent: goWithOutput.nextEvent};
        navigate('/minigame', {state: data});
    }, [goWithOutput]);
